...
2. **Context** — 유저/프로젝트/폴더 스코프로 계층 기록. 위로 갈수록 추상적. 전부 싣지 말고 "이 상황에서는 이걸 참고해"로 유도해 필요한 것만 읽게 한다.
...
6. **Compounding** — 회고를 기록한다(`.dev/retrospect/`, `.dev/learning/`). 같은 작업이 반복되면 스킬/커맨드 추출을 논의하고, 같은 실수가 반복되면 Scaffolding에서 훅이나 장치를 추가한다.
